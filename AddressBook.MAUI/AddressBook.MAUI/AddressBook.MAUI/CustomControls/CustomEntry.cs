using System;
namespace AddressBook.MAUI.CustomControls
{
    public class CustomEntry : Entry
    {
        ...
        public static readonly BindableProperty BorderWidthProperty = BindableProperty.Create(nameof(BorderWidth), typeof(int), typeof(CustomEntry), 2);
